...
Partial Class admin_addnews
    ...
    Protected Sub btnsub_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnsub.Click
        ...
        If Session("trans") = "update" Then
            query = "update news set heading='" & txtnewshd.Text & "',newsdetail='" & txtnewsdetails.Text & "',newstype='" & txtnewstype.Text & "',newsby='" & txtnewsby.Text & "',newsfor='" & txtnewsfor.Text & "' where newsid='" & txtnewsid.Text & "'"
        ...
        If Session("trans") = "new" Then
            ...
            query = "insert into news(newsdate,heading,newsdetail,newstype,newsby,newsfor) values('" & dc.chgdate(Today.Date) & "','" & txtnewshd.Text & "','" & txtnewsdetails.Text & "','" & txtnewstype.Text & "','" & txtnewsby.Text & "','" & txtnewsfor.Text & "')"
    ...
    Private Sub reptupdate(ByVal id As Integer)
        ...
        txtnewsid.Text = rw("newsid")

        txtnewshd.Text = rw("heading")
        txtnewsdetails.Text = rw("newsdetail")
        txtnewstype.Text = rw("newstype")
        txtnewsby.Text = rw("newsby")
        txtnewsfor.Text = rw("newsfor")
